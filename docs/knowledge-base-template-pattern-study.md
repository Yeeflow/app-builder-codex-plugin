...
- `validate-yap-package.js /Users/Renger/Downloads/Knowledge Base_1.yap --mode compatibility`: passed with warnings
- `validate-yap-graph.js /Users/Renger/Downloads/Knowledge Base_1.yap --mode compatibility`: passed with warnings
