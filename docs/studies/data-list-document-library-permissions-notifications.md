...
Proof boundary: export-proven for Data List permission flags and Data List `RemindRules` notification schema found in `/Users/Renger/Downloads/Data Lists (1).yap`; product-documented only for Document Library applicability; Form Report negative rule; not runtime-proven for permission enforcement or notification delivery.
...
- Data List / Document Library permissions: `https://<yourdomain>.yeeflow.com/<redacted-path>
- Data List / Document Library notifications: `https://<yourdomain>.yeeflow.com/<redacted-path>
