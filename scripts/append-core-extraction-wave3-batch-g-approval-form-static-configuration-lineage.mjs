...
const existing = lineage.approvedTransitions.find((transition) => transition.phase === phase);
const previous = existing ? lineage.approvedTransitions.at(-2) : lineage.approvedTransitions.at(-1);
if (previous?.phase !== "core-extraction-wave3-batch-f-small-static-leaf-cohort") throw new Error("CORE_EXTRACTION_WAVE3_BATCH_G_LINEAGE_BASELINE_INVALID");
...
const transition = {
  ...
  requiredEvidenceMarker: "CORE_EXTRACTION_WAVE3_BATCH_G_APPROVAL_FORM_STATIC_CONFIGURATION_PASSED",
  sourceTransition: {
    beforeSha256: previous.sourceTransition.afterSha256,
    afterSha256: sha(read("scripts/materialize-full-app-generated-final.mjs")),
    requiredSourceTokens: ["coreProjectApprovalFormStaticConfiguration", "unique-field-specs", "public-field-selection", "no-fields-notice"],
  },
  beforeArtifactState: previous.artifactState,
  artifactState,
  allowedFiles: [
    evidencePath, reportPath,
    "compatibility/differential-fixtures/core-extraction-wave3-batch-g-approval-form-static-configuration.v0.1.0.json",
    "packages/app-builder-core-materializer/src/internal/approval-form-static-configuration.ts",
    "packages/app-builder-core-materializer/src/index.ts",
    "packages/app-builder-core-materializer/lib/index.js",
    "packages/app-builder-core-materializer/lib/internal/approval-form-static-configuration.js",
    ...
    "scripts/test-core-extraction-wave3-batch-g-approval-form-static-configuration.mjs",
    "scripts/test-core-extraction-wave3-batch-g-legacy-rollback.mjs",
    "scripts/validate-core-extraction-wave3-batch-g-approval-form-static-configuration.mjs",
    ...
    "scripts/create-core-extraction-wave3-batch-g-approval-form-static-configuration-evidence.mjs",
    "scripts/append-core-extraction-wave3-batch-g-approval-form-static-configuration-lineage.mjs",
    ...
    "compatibility/capability-manifests/core-extraction-production-ownership-inventory.v1.1.0.json",
    "compatibility/capability-manifests/core-extraction-proof-envelope-registry.v1.1.0.json",
    "compatibility/capability-manifests/core-extraction-finite-wave-plan.v0.12.0.json",
...
console.log(existing ? "CORE_EXTRACTION_WAVE3_BATCH_G_LINEAGE_RECONCILED" : "CORE_EXTRACTION_WAVE3_BATCH_G_LINEAGE_APPENDED");
