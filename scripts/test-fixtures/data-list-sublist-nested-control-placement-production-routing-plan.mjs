export function dataListSublistNestedControlPlacementProductionRoutingPlan() {
...
#### Fields
| Display Name | Storage Name | Exact Yeeflow Field Type | Control | Sublist Columns | Notes |
| --- | --- | --- | --- | --- | --- |
| Leave balance title | Title | Text | input | | Native title field. |
| Leave details | Text7 | Text | list | Note:Note:text:input:note-column:true; Date:Date:date:datepicker:date-column:true; Amount:Amount:decimal:input_number:amount-column:true | Export-proven scalar embedded child controls only. |
...
| --- | --- | --- | --- |
| Operations | Employee Leave Balances | Employee Leave Balances | Data List |
`;
}
