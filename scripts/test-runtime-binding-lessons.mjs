...
tempVariablePage.children[0].children.push({
  id: "kpi_open_resources",
  type: "heading",
  attrs: { headc: { title: { variable: [{ exprType: "variable", id: "__temp_var_open_resources", name: "var_open_resources" }] } } },
});
