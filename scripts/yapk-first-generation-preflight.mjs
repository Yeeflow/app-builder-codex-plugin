...
export function runYapkFirstGenerationPreflight(packagePath, options = {}) {
  ...
  gates.push(runGate("planning-placeholder-materialization", [
    "scripts/validate-planning-placeholder-materialization.mjs",
    "--package",
    resolvedPackage,
    ...(plan ? ["--plan", plan] : []),
  ]));
  ...
  gates.push(runGate("form-action-open-resource", [
    "scripts/validate-form-action-open-resource.mjs",
    "--package",
    resolvedPackage,
    "--strict-generated",
    ...(plan ? ["--plan", plan] : []),
