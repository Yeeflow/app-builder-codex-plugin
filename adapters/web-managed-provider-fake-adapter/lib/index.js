...
export function createManagedProviderFakeModelPort(intent) {
...
export async function executeWithManagedProviderFake(input, modelPort, kernel = createInProcessExecutionKernel()) {
