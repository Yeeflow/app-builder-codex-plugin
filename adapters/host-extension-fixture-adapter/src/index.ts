...
export function createHostExtensionFixtureModelPort(intent: StructuredApplicationIntent): ModelInvocationPort {
...
export async function executeWithHostExtensionFixture(
  input: HostExtensionExecutionInput,
...
function rejectedRequest(input: HostExtensionExecutionInput) {
...
function modelFailure(input: HostExtensionExecutionInput): ExecutionResult {
  return Object.freeze({
    protocolVersion: EXECUTION_PROTOCOL_VERSION,
    requestId: input.requestId,
    status: "rejected",
