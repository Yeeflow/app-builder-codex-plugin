...
function wfStaticRejectedVertices(source: Readonly<Record<string,unknown>>, target: Readonly<Record<string,unknown>>): unknown[] {
  ...
  if(signedDx>=0&&dx<520&&dy<220)return [];
