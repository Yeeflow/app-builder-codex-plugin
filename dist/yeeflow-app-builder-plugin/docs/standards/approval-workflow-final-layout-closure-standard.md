...
4. Route only the final SequenceFlows. Local forward, merge, and local rejected links use rounded auto-routing; long, cross-row, backward, and return links use safe explicit `vertices[]`.
