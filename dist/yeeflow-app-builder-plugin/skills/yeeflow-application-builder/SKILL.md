...
For package delivery, use App Builder MCP tools only after explicit confirmation and a user-selected workspace from `workspace_list`; MCP acceptance remains distinct from runtime proof.
