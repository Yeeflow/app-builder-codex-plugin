...
For high-quality dashboard/content fidelity claims, also validate control-property fidelity with `scripts/inspect-ui-control-property-fidelity.mjs` before final UI-quality/design-fidelity claims.
