...
for(const extra of ['docs/templates/dashboard-page-layouts-custom-code/distribution-files.json','docs/standards/product-schema/distribution-files.json','docs/standards/native-collection-density-distribution.json']) manifest.mirrors.push(...JSON.parse(fs.readFileSync(path.join(root,extra),'utf8')).mirrors);
...
try{
 ...
 execFileSync(process.execPath,['scripts/test-collection-native-density.mjs'],{cwd:payload,stdio:'pipe'});
 execFileSync(process.execPath,['-e',"require('./skills/yeeflow-application-generator/scripts/collection-control-generation-standard.js')"],{cwd:payload,stdio:'pipe'});
