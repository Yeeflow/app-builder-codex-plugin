...
try { require(target).parseCli("copilot"); } catch (error) { console.log(JSON.stringify({ status: "fail", code: error.code || "YAIC_VALIDATE_FAILED", message: error.message }, null, 2)); process.exit(1); }
